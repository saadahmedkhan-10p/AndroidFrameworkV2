...
public class LoginTest extends AppFactory {
    ...
    public void verifyInvalidCreds(){
        utilities.log().info("This test is used to verify invalid creds and get error message");
    ...
    public void verifyValidUserLogin() throws InterruptedException {
        utilities.log().info("This test is used to login with valid creds");
